...
import { RoleSaveApi, RoleUpdateApi, RoleInfoApi } from "@/api/sys/role.js"
import { WarningConfirm, SuccessMessage } from "@/utils/message.js";
import { MenuListApi } from "@/api/sys/menu.js";
export default {
  data() {
    return {
      visible: false,
  ...
  methods: {
    init(id) {
      ...
      MenuListApi().then((data) => {
        ...
        if (this.dataForm.id) {
          RoleInfoApi(this.dataForm.id).then((data) => {
