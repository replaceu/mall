...
public class AttrController {
	 ...
	 */
	@ApiOperation("获取属性列表")
	@ApiImplicitParams({ @ApiImplicitParam(name = "attrType", value = "属性类型", allowableValues = "0,1", paramType = SwaggerParamType.PATH, dataType = "int", required = true), @ApiImplicitParam(name = "categoryId", value = "分类id", paramType = SwaggerParamType.PATH, dataType = "long", required = true) })
