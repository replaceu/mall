...
import {ProductAttrListApi, ProductAttrDeleteApi} from "@/api/product/attr.js"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      ProductAttrListApi(this.attrtype, this.catId, {
        page: this.pageIndex,
        limit: this.pageSize,
    ...
    deleteHandle(id) {
      ...
      WarningConfirm(() => {
        ProductAttrDeleteApi(this.attrtype, ids).then((data) => {
          SuccessMessage("删除成功");
          this.getDataList();
        })
